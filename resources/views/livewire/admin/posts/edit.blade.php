<div>
    <div class="admin-header">
        <div class="admin-title">
            <h1>Edit Post</h1>
            <p>Modify article details and republish</p>
        </div>
        ...
        <div class="grid-2-1">
            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                ...
                <div class="panel-card">
                    ...
                    <button type="submit" class="btn" style="width: 100%; margin-top: 8px;">Update Post</button>
                </div>
                ...
                <div class="panel-card">
                    ...
                    <div class="image-upload-wrapper" onclick="document.getElementById('image-upload-input').click()">
                        ...
                        @elseif ($existingImage)
                            <div style="font-size: 0.85rem; color: var(--accent-color);">Existing Image:</div>
                            <img src="{{ asset($existingImage) }}" class="image-preview" alt="Existing">
                            <p style="font-size: 0.75rem; color: var(--admin-text-muted); margin-top: 8px;">Click to replace this image</p>
                        @else
