    ...
    <form wire:submit.prevent="saveSettings">
        <div class="grid-2-1">
            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                ...
                <!-- SEO Configuration Panel Card -->
                <div class="panel-card">
                    <h2 class="panel-title" style="margin-bottom: 20px; border-bottom: 1px solid var(--admin-border); padding-bottom: 8px;">SEO Meta Configuration</h2>
                    
                    <!-- Home SEO -->
                    <div style="margin-bottom: 24px; border-bottom: 1px dashed var(--admin-border); padding-bottom: 16px;">
                        <h3 style="font-size: 1.05rem; margin-bottom: 12px; color: var(--accent-color); font-family: var(--font-heading);">Home Page SEO</h3>
                        ...
                        <div class="admin-form-group" style="margin-top: 12px;">
                            ...
                            <textarea wire:model="seo_home_description" class="admin-control" style="height: 60px; resize: vertical;" placeholder="Brief summary of your blog for search engine results..."></textarea>
                    ...
                    <!-- About SEO -->
                    <div style="margin-bottom: 24px; border-bottom: 1px dashed var(--admin-border); padding-bottom: 16px;">
                        <h3 style="font-size: 1.05rem; margin-bottom: 12px; color: var(--accent-color); font-family: var(--font-heading);">About Page SEO</h3>
                        ...
                        <div class="admin-form-group" style="margin-top: 12px;">
                            <label class="admin-label">Meta Description</label>
                            <textarea wire:model="seo_about_description" class="admin-control" style="height: 60px; resize: vertical;" placeholder="Brief summary of the about/biography page..."></textarea>
                    ...
                    <!-- Contact SEO -->
                    <div>
                        <h3 style="font-size: 1.05rem; margin-bottom: 12px; color: var(--accent-color); font-family: var(--font-heading);">Contact Page SEO</h3>
                        ...
                        <div class="admin-form-group" style="margin-top: 12px;">
                            <label class="admin-label">Meta Description</label>
                            <textarea wire:model="seo_contact_description" class="admin-control" style="height: 60px; resize: vertical;" placeholder="Brief summary of the contact/inquiry page..."></textarea>
